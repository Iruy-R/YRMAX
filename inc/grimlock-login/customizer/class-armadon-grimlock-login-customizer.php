<?php
/**
 * Armadon_Grimlock_Login_Customizer Class
 *
 * @author  Themosaurus
 * @since   1.0.3
 * @package armadon
 ...
 */
class Armadon_Grimlock_Login_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.3
	...
	public function change_defaults( $defaults ) {
		...
		$defaults['login_background_image'] = get_stylesheet_directory_uri() . '/assets/images/pages/page-login.jpg';
		return $defaults;
	}

}

return new Armadon_Grimlock_Login_Customizer();
