<?php
/**
 * Armadon_Grimlock_Table_Customizer Class
 *
 * @author  Themosaurus
 * @since   1.0.0
 * @package armadon
 ...
 */
class Armadon_Grimlock_Table_Customizer {
	/**
	 * Setup class.
	 *
	 * @since 1.0.0
	...
	public function change_defaults( $defaults ) {
		return array_merge( $defaults, array(
			'table_border_width'             => ARMADON_BORDER_WIDTH,
			'table_border_color'             => ARMADON_FADED,
			'table_striped_background_color' => ARMADON_FADED,
		) );
	}
...
return new Armadon_Grimlock_Table_Customizer();
